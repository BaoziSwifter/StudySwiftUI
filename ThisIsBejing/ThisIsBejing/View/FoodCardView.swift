    ...
    var body: some View {
        ZStack {
            ...
            Image(food.image)
                ...
                .background(
                    Circle().fill(LinearGradient(gradient: Gradient(colors: [Color("ColorBrownMedium"), Color("ColorBrownLight")]), startPoint: .trailing, endPoint: .leading))
